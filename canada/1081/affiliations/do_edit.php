...
if ($stm_logged_state==0) {
	...
	if (mysqli_num_rows(mysqli_query($con, $chk_exist))==0 || $dataID=="" || $dataTitle=="" || $dataPosition=="" || $dataLink=="") {
		print "<script language=\"JavaScript\">
		alert (\"Data Does Not Exists Or Some Fields Are Missing.\");
		history.back();
		</script>";
	} else {
		$update_data="update affiliations set title='$dataTitle', link='$dataLink', position='$dataPosition', details='$dataDetails' where id='$dataID'";
