	...
	<tr>
		...
		<tr>
			...
			<h3>Affiliations</h3>
				...
				<?php
				$query1="select * from affiliations order by position asc";
				...
				$rpp = 8; // results per page
						...
						while(($count<$rpp) && ($i<$tcount)) {
							...
							$dataLink=html_entity_decode($query['link']);
							$dataImage=$query['image'];

							print "<tr $rowAltHead>
										
										<td>$dataPostion</td>
										<td><img src='$common_path/uploads/affiliations/$dataImage' height='40px' border='0' alt='$dataTitle'></td>
										<td>$dataTitle</td>
										<td>$dataLink</td>
