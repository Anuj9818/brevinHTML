...
$navigationSelected="introductionManagement";
...
<tr>
	...
	<tr>
		...
		<?php
		$post_id=$_GET['id'];
		$check_exist="select * from introduction where id='$post_id'";
		if (mysqli_num_rows(mysqli_query($con, $check_exist))==0 || $post_id=="") {
			...
			$dataHome=html_entity_decode($each_fields['home']);
		...
		<tr>
			<th>Title:</th>
			<td><input type="text" name="title" size="30" value="<?php print $dataTitle;?>"></td>
		</tr>
		<tr>
			<th>Homepage:</th>
			<td><textarea name="home" cols="45" rows="10"><?php print $dataHome;?></textarea></td>
		</tr>
		<tr>
			<th>Details:</th>
