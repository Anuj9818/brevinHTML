...
<tr>
	...
	<tr>
		...
		<tr>
			<td>
				<h3>Introduction Management</h3>
				<?php
				$query1="select * from introduction order by id desc";
				...
				$rpp = 8; // results per page
						...
						while(($count<$rpp) && ($i<$tcount)) {
							...
							$dataHome=html_entity_decode($query['home']);
							$shortDataDetails=substr(strip_tags($dataHome), 0, 300);

							print "<tr $rowAltHead>
										<td>$dataTitle</td>
										<td>$shortDataDetails</td>
