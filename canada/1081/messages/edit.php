...
<tr>
	...
	<tr>
		...
		<?php
		$post_id=$_GET['id'];
		$check_exist="select * from messages where id='$post_id'";
		if (mysqli_num_rows(mysqli_query($con, $check_exist))==0 || $post_id=="") {
			...
			$dataName=$each_fields['name'];
			$dataDesignation=$each_fields['designation'];
		...
		<form name="edit" method="post" action="do_edit.php">
			...
			<tr>
				<th>Name:</th>
				<td><input type="text" name="name" size="60" value="<?php print $dataName;?>"></td>
			</tr>
			<tr>
				<th>Designation:</th>
				<td><input type="text" name="designation" size="60" value="<?php print $dataDesignation;?>"></td>
			</tr>
			<tr>
				<th>Order:</th>
				<td><input type="text" name="position" size="30" value="<?php print $dataPosition;?>"></td>
			</tr>
			<tr>
				<th>Details:</th>
