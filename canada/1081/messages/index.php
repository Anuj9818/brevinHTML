...
$navigationSelected="messagesManagement";
	...
	<tr>
		...
		<tr>
			...
			<h3>Messages</h3>
				...
				<?php
				$query1="select * from messages order by position asc";
				...
				$rpp = 8; // results per page
						...
						while(($count<$rpp) && ($i<$tcount)) {
							...
							$dataName=$query['name'];
							$dataDesignation=$query['designation'];
							$dataImage=$query['image'];

							print "<tr $rowAltHead>
										
										<td>$dataPostion</td>
										<td><img src='$common_path/uploads/messages/$dataImage' height='80px' border='0' alt='$dataTitle'></td>
										<td>$dataName</td>
