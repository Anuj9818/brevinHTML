...
<section id="subpage-wrap">
	<div class="container clearfix">
		<div id="subpage-full" class="clearfix">
			...
			if ($id > 0) {
				...
				if(mysqli_num_rows($getDataQuery)==0) {
					...
					$dataPosition=$eachData['position'];
					$dataImg=$eachData['image'];
					$dataDetails=html_entity_decode($eachData['details']);
					print "<h2>$dataTitle</h2><br><img src='$common_path/uploads/services/$dataImg' class='sub-img'><br>
						$dataDetails";
				}
				...
				if ($totalrows == 0) {
					...
					while(($count<$rpp) && ($i<$tcount)) {
						...
						print "<div class='news-listing'><img src='$common_path/uploads/services/$dataImg' class='sub-img' style='max-width:150px;'>
							<a href='$common_path/services.php?id=$dataID' class='titleMenu'>$dataTitle</a>
							<p>$dataShortDetails ...
								<a href='$common_path/services.php?id=$dataID' class='underline'>read more</a>
							</p><br>
						</div>";
