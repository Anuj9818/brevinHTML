...
if ($stm_logged_state==0) {
	...
	$chk_exist="select * from activities where id='$dataID'";
	if (mysqli_num_rows(mysqli_query($con, $chk_exist))==0 || $dataID=="" || $dataTitle=="" || $dataPosition=="") {
		...
		$update_data="update activities set title='$dataTitle', position='$dataPosition', details='$dataDetails' where id='$dataID'";
