		...
		if ($dataTitle=="" || $dataPosition=="" || $dataDetails=="") {
			...
			if ($_FILES['image']['name']=="") {
				...
				if (($_FILES["image"]["type"] == "image/jpg") || ($_FILES["image"]["type"] == "image/jpeg") || ($_FILES["image"]["type"] == "image/gif") || ($_FILES["image"]["type"] == "image/png") || ($_FILES["image"]["type"] == "image/pjpeg")) {
					...
					$uploadImg=move_uploaded_file($_FILES['image']['tmp_name'], "../../uploads/alpine_training/tmp_$filename");
					if ($uploadImg==true) {
						
						$sourcefile="../../uploads/alpine_training/tmp_$filename";
						$destfile="../../uploads/alpine_training/$filename";
						resizeImage_GD2('1000', '1000', $sourcefile, $destfile);
						unlink("../../uploads/alpine_training/tmp_$filename");
			...
			$addData=mysqli_query($con, "insert into alpine_training values ('','$dataTitle','$dataPosition','$thumbImgFile','$dataDetails')");
			if ($addData==true) {
				print "<script language=\"JavaScript\">
