...
$navigationSelected="alpineTrainingManagement";
...
<tr>
	...
	<tr>
		...
		<tr>
			<td>
			<h3>Alpine Training</h3>
			
				
				<?php
				$query1="select * from alpine_training order by position asc";
				...
				$rpp = 8; // results per page
						...
						while(($count<$rpp) && ($i<$tcount)) {
							...
							print "<tr $rowAltHead>
										...
										<td>$dataPostion</td>
										<td><img src='$common_path/uploads/alpine_training/$dataImage' width='100px' border='0' alt='$dataTitle'></td>
										<td>$dataTitle</td>
