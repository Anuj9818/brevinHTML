...
$navigationSelected="giveBackManagement";
	...
	<tr>
		...
		<tr>
			...
			<h3>Give Back</h3>
				...
				<?php
				$query1="select * from give_back order by position asc";
				...
				$rpp = 8; // results per page
						...
						while(($count<$rpp) && ($i<$tcount)) {
							...
							print "<tr $rowAltHead>
										...
										<td>$dataPostion</td>
										<td><img src='$common_path/uploads/give_back/$dataImage' width='100px' border='0' alt='$dataTitle'></td>
										<td>$dataTitle</td>
