...
<tr>
	...
	<tr>
		...
		<tr>
			<td>
			<?php
					$query="select * from big_slider order by position asc";
					...
					$rpp = 8; // results per page
							...
							while(($count<$rpp) && ($i<$tcount)) {
								...
								print "<tr $rowAltHead>
											<td>$dataPosition</td>
											<td><img src='$common_path/uploads/big_slider/$dataImage' width='100px' border='0' alt='$dataTitle'></td>
											<td>$dataTitle</td>
											<td>$dataTitle2</td>
											<td>$dataLink</td>
