		...
		if ($dataTitle=="" || $dataDate=="") {
			...
			if ($_FILES['image']['name']=="") {
				...
				if (($_FILES["image"]["type"] == "image/jpg") || ($_FILES["image"]["type"] == "image/jpeg") || ($_FILES["image"]["type"] == "image/gif") || ($_FILES["image"]["type"] == "image/png") || ($_FILES["image"]["type"] == "image/pjpeg")) {
					...
					$uploadImg=move_uploaded_file($_FILES['image']['tmp_name'], "../../uploads/latest_news/tmp_$filename");
					if ($uploadImg==true) {
						
						$sourcefile="../../uploads/latest_news/tmp_$filename";
						$destfile="../../uploads/latest_news/$filename";
						resizeImage_GD2('1000', '1000', $sourcefile, $destfile);
						unlink("../../uploads/latest_news/tmp_$filename");
			...
			$addData=mysqli_query($con, "insert into latest_news values ('','$dataTitle','$dataDate','$dataDetails','$thumbImgFile')");
			if ($addData==true) {
				print "<script language=\"JavaScript\">
