...
if ($stm_logged_state==0) {
	...
	$chk_exist="select * from press_release where id='$dataID'";
	if (mysqli_num_rows(mysqli_query($con, $chk_exist))==0 || $dataID=="" || $dataTitle=="" || $dataDate=="" || $dataDetails=="") {
		print "<script language=\"JavaScript\">
		alert (\"Data Does Not Exists Or Some Fields Are Missing.\");
		history.back();
		</script>";
	} else {
		$update_data="update press_release set title='$dataTitle', details='$dataDetails', date='$dataDate' where id='$dataID'";
