...
$navigationSelected="sportsClimbingManagement";
...
<tr>
	...
	<tr>
		...
		<tr>
			<td>
			<h3>Sports Climbing</h3>
			
				
				<?php
				$query1="select * from sports_climbing order by position asc";
				...
				$rpp = 8; // results per page
						...
						while(($count<$rpp) && ($i<$tcount)) {
							...
							print "<tr $rowAltHead>
										...
										<td>$dataPostion</td>
										<td><img src='$common_path/uploads/sports_climbing/$dataImage' width='100px' border='0' alt='$dataTitle'></td>
										<td>$dataTitle</td>
