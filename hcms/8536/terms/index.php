...
$navigationSelected="termsManagement";
	...
	<tr>
		...
		<tr>
			...
			<h3>Terms & Condition</h3>
				...
				<?php
				$query1="select * from terms order by position asc";
					$result1=mysqli_query($con, $query1);
					$totalrows=mysqli_num_rows($result1);
					if ($totalrows==0) {							
						print "<span class=\"error\">No terms Exist.</span>";
					} else {
				...
				$rpp = 8; // results per page
						...
						while(($count<$rpp) && ($i<$tcount)) {
							...
							print "<tr $rowAltHead>
										<td>$dataPosition</td>
										<td>$dataTitle</td>
										<td><A href=\"edit.php?id=$dataID\" class=\"remarkMenu\" title=\"EDIT\">Edit</a> - <a href=\"delete.php?id=$dataID\" class=\"remarkMenu\" title=\"DELETE\">Delete</a></td>
									</tr>";
