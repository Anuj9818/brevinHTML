		...
		if ($dataName=="" || $dataPosition=="") {
			...
			if ($_FILES['image']['name']=="") {
				...
				if (($_FILES["image"]["type"] == "image/jpg") || ($_FILES["image"]["type"] == "image/jpeg") || ($_FILES["image"]["type"] == "image/png") || ($_FILES["image"]["type"] == "image/gif") || ($_FILES["image"]["type"] == "image/pjpeg")) {
					...
					$uploadImg=move_uploaded_file($_FILES['image']['tmp_name'], "../../uploads/testimonials/tmp_$filename");
					if ($uploadImg==true) {
						
						$sourcefile="../../uploads/testimonials/tmp_$filename";
						$destfile="../../uploads/testimonials/$filename";
						resizeImage_GD2('500', '500', $sourcefile, $destfile);
						unlink("../../uploads/testimonials/tmp_$filename");
			...
			$addData=mysqli_query($con, "insert into testimonials values ('', '$dataName', '$dataPosition', '$dataDetails', '$thumbImgFile')");
			if ($addData==true) {
				print "<script language=\"JavaScript\">
