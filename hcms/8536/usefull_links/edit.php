...
<tr>
	...
	<tr>
		...
		<?php
		$post_id=$_GET['id'];
		$check_exist="select * from usefull_links where id='$post_id'";
		if (mysqli_num_rows(mysqli_query($con, $check_exist))==0 || $post_id=="") {
			...
			$dataWebsite=$each_fields['website'];
		?>
		<h3>Modify Data</h3>
		...
		<tr>
			<th>Website: *</th>
			<td><input type="text" name="website" size="40" value="<?php print $dataWebsite;?>"></td>
		</tr>
		<tr>
			<th></th>
