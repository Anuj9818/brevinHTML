...
<tr>
	...
	<tr>
		...
		<?php
		$post_id=$_GET['id'];
		$check_exist="select * from video where id='$post_id'";
		...
		<tr>
			<th>Video Url:</th>
			<td><input type="text" name="video" size="60" value="<?php print $dataUrl;?>"></td>
		</tr>
		<tr>
			<th>Details:</th>
			<td><textarea name="details" cols="45" rows="10"><?php echo $dataDetails;?></textarea></td>
		</tr>
		<tr>
			<th></th>
