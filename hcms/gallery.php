				...
				if(mysqli_num_rows($getDataQuery)==0) {
					...
					if (mysqli_num_rows($getPhotos)>0) {
						...
						while ($eachPhotos=mysqli_fetch_array($getPhotos)) {
							...
							print "<li>
								<a href=\"$common_path/uploads/gallery/$dataImg\" data-lightbox='roadtrip' title=\"$dataTitle\" class=\"photolink\"><img src='$common_path/uploads/gallery/$dataImg' width='170' height='120' border='0' alt='$title'></a>
							</li>";
						}
						print "</ul>";
					} else {
