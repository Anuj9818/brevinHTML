...
<section id="header-about">
	...
	<?php
		...
		$getDataQuery=mysqli_query($con, "select * from resources where id='$id'");								
		...
		<?php
				...
				if ($id > 0) {
					...
					if(mysqli_num_rows($getDataQuery)==0) {
						...
						print "<img src='$common_path/uploads/resources/$dataImg' width='auto' alt='$dataTitle' class='sub-img'>
						<p>$dataDetails</p>";
					}
					...
					if ($totalrows == 0) {
						...
						while($query = mysqli_fetch_array($result)) {
							...
							print "<li>
								<a href='$common_path/resources.php?id=$dataID'>
								<img src='$common_path/iuploads/resources/$dataImg' alt='$dataTitle'></a>
								<br><br><strong><a href='$common_path/resources.php?id=$dataID'>$dataTitle</a></strong><BR><BR>
						</li>";
