...
<tr>
	...
	<tr>
		<td>
		<h3>Big Slideshow Images Management</h3>
		<table border="0" cellpadding="0" cellspacing="0">
		<tr>
			<td>
			<?php
					$query="select * from highlight_big order by position asc";
					...
					$rpp = 10; // results per page
							...
							while(($count<$rpp) && ($i<$tcount)) {
								...
								print "<tr $rowAltHead>
											<td><img src='$common_path/uploads/highlight_big/$dataImage' width='200px' border='0' alt='$dataTitle'></td>
											<td>$dataPosition</td>
