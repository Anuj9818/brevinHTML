		...
		if ($dataName=="" || $dataDesignation=="" || $dataPosition=="") {
			...
			if ($_FILES['image']['name']=="") {
				...
				if (($_FILES["image"]["type"] == "image/jpg") || ($_FILES["image"]["type"] == "image/jpeg") || ($_FILES["image"]["type"] == "image/png") || ($_FILES["image"]["type"] == "image/gif") || ($_FILES["image"]["type"] == "image/pjpeg")) {
					...
					$uploadImg=move_uploaded_file($_FILES['image']['tmp_name'], "../../uploads/message/tmp_$filename");
					if ($uploadImg==true) {
						
						$sourcefile="../../uploads/message/tmp_$filename";
						$destfile="../../uploads/message/$filename";
						resizeImage_GD2('300', '300', $sourcefile, $destfile);
						unlink("../../uploads/message/tmp_$filename");
			...
			$addData=mysqli_query($con, "insert into message values ('', '$dataName', '$dataDesignation', '$dataPosition', '$dataDetails', '$thumbImgFile')");
			if ($addData==true) {
				print "<script language=\"JavaScript\">
