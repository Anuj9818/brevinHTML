...
<tr>
	...
	<tr>
		...
		<?php
		$post_id=$_GET['id'];
		$check_exist="select * from news where id='$post_id'";
		...
		<form name="edit_news" method="post" action="do_edit.php">
		...
		<tr>
			<th>Date:</th>
			<td><input type="text" name="added_date" size="20" value="<?php print $dataDate;?>"></td>
		</tr>
		<tr>
			<th>Details:</th>
