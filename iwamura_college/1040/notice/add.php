...
<tr>
	...
	<tr>
		...
		<form name="add_notice" method="post" enctype="multipart/form-data" action="do_add.php">
		...
		<tr>
			<th>Date:</th>
			<td><input type="text" name="added_date" size="20" value="<?php print date('d F, Y'); ?>"></td>
		</tr>
		<tr>
			<th>Details:</th>
