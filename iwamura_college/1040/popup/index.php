	...
	<tr>
		...
		<h3>Popup Banner Management</h3>
			...
			<?php
					...
					$rpp = 10; // results per dprofile
							$adjacents = 10;

							$dprofile = intval($_GET["dprofile"]);
							if(!$dprofile) $dprofile = 1;
							...
							// count number of dprofiles:
							$tpage = ($tcount) ? ceil($tcount/$rpp) : 1; // total dprofiles, last dprofile number
							...
							print adminPagination($reload, $dprofile, $tpage, $adjacents);
						}
					?>
				</td>
			</tr>
