...
if ($stm_logged_state==0) {
	...
	if (mysqli_num_rows(mysqli_query($con, $chk_exist))==0 || $dataID=="" || $dataAddress=="" || $dataPhone=="" || $dataEmail=="") {
		print "<script language=\"JavaScript\">
		alert (\"Some Fields Are Missing.\");
		history.back();
		</script>";
	} else {
		$update_data="update contactus set address='$dataAddress', phone='$dataPhone', Email='$dataEmail', details='$dataDetails' where id='$dataID'";
