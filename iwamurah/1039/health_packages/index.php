...
$navigationSelected="healthPackagesManagement";
?>
...
<tr>
	...
	<tr>
		...
		<h3>Health Packages</h3>
			...
			<?php
					$query="select * from health_packages order by position asc";
					...
					$rpp = 10; // results per page
							...
							while(($count<$rpp) && ($i<$tcount)) {
								...
								print "<tr $rowAltHead>
											<td>$dataPosition</td>
											<td><img src='$common_path/uploads/health_packages/$dataImage' width='200px' border='0' alt='$dataTitle'></td>
											<td>$dataTitle</td>
