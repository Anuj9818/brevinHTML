		...
		if ($dataTitle=="" || $dataPosition=="" ) {
			...
			if ($_FILES['image']['name']=="") {
				...
				if (($_FILES["image"]["type"] == "image/jpg") || ($_FILES["image"]["type"] == "image/jpeg") || ($_FILES["image"]["type"] == "image/png") || ($_FILES["image"]["type"] == "image/gif") || ($_FILES["image"]["type"] == "image/pjpeg")) {
					...
					$uploadImg=move_uploaded_file($_FILES['image']['tmp_name'], "../../uploads/home_articles/tmp_$filename");
					if ($uploadImg==true) {
						
						$sourcefile="../../uploads/home_articles/tmp_$filename";
						$destfile="../../uploads/home_articles/$filename";
						resizeImage_GD2('273', '273', $sourcefile, $destfile);
						unlink("../../uploads/home_articles/tmp_$filename");
			...
			$addData=mysqli_query($con, "insert into home_articles values ('', '$dataTitle', '$dataPosition', '$dataDetails', '$thumbImgFile')");
			if ($addData==true) {
				print "<script language=\"JavaScript\">
