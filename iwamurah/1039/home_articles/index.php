...
$navigationSelected="homeArticlesManagement";
?>
...
<tr>
	...
	<tr>
		...
		<tr>
			<td>
		<h3>Highlight Articles Management</h3>
			...
			<?php
					...
					$rpp = 10; // results per page
							...
							while(($count<$rpp) && ($i<$tcount)) {
								...
								print "<tr $rowAltHead>
											<td>$dataPosition</td>
											<td><img src='$common_path/uploads/home_articles/$dataImage' width='200px' border='0' alt='$dataTitle'></td>
											<td>$dataTitle</td>
