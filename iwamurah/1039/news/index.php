...
<tr>
	...
	<tr>
		...
		<tr>
			<td>
			<?php
					$query="select * from news order by posted_date desc";
					...
					$rpp = 8; // results per page
							...
							while(($count<$rpp) && ($i<$tcount)) {
								...
								print "<tr $rowAltHead>
											<td>$dataDate</td>
											<td><img src='$common_path/uploads/news/$dataImage' height='60px' border='0' alt='$dataTitle'></td>
											<td>$dataTitle</td>
